                ...
                >
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                            ...
                            >
                                ...
                                <a class="dropdown-item">
                                    <div class="item-thumbnail">
                                        <img
                                            src="backend/images/faces/face4.jpg"
                                            alt="image"
                                            class="profile-pic"
                                        />
                                    </div>
                                ...
                                <a class="dropdown-item">
                                    <div class="item-thumbnail">
                                        <img
                                            src="backend/images/faces/face2.jpg"
                                            alt="image"
                                            class="profile-pic"
                                        />
                                    </div>
                                ...
                                <a class="dropdown-item">
                                    <div class="item-thumbnail">
                                        <img
                                            src="backend/images/faces/face3.jpg"
                                            alt="image"
                                            class="profile-pic"
                                        />
                                    </div>
                                ...
                                <a class="dropdown-item">
                                    <div class="item-thumbnail">
                                        <div class="item-icon bg-success">
                                            <i
                                                class="mdi mdi-information mx-0"
                                            ></i>
                                        </div>
                                    </div>
                                ...
                                <a class="dropdown-item">
                                    <div class="item-thumbnail">
                                        <div class="item-icon bg-info">
                                            <i
                                                class="mdi mdi-account-box mx-0"
                                            ></i>
                                        </div>
                                    </div>
                                    <div class="item-content">
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            >
                                <img
                                    src="https://ui-avatars.com/api/?name={{ auth()->guard('admin')->user()->name }}"
                                    alt="profile"
                                />
